...
int main(int argc, char *argv[])
{
	...
	DEModel::PsiElec psi_elec({"E_1", "E_2", "E_3", "F_inv_11", "F_inv_21", "F_inv_31", "F_inv_12", "F_inv_22", "F_inv_23", "F_inv_31", "F_inv_32", "F_inv_33"}, {}, epsilon);

	Eigen::VectorXd arguments(12), parameters(1);
