...
int main(int argc, char *argv[])
{
	...
	DEModel::PsiSurf psi_surf({"u_1,1", "u_1,2", "u_1,3", "u_2,1", "u_2,2", "u_2,3", "u_3,1", "u_3,2", "u_3,3"}, {"x_1", "x_2", "x_3", "n_1", "n_2", "n_3"}, lambda_S, mu_S);

	Eigen::VectorXd arguments(9), parameters(6);
	arguments << 0.14109, 0.58873, 0.33273, 0.16916, 0.78525, 0.39318, 0.79193, 0.63440, 0.552314;
	parameters << 0.0, 0.0, 0.0, 0.33835, 0.74636, 0.57312;
